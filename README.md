...
```bash
python cast_off.py ./ZFC_5837.NEF --border l0.1,r0.1 --level-pixel-threshold r0.001,g0.001,b0.03  --wb-ix 4,1 --debug --visualize  --tone-pixel-threshold 0.03  --tone-white 64000 --level-white-point "b61000"
```
